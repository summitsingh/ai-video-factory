...
def _judge_narration_chunk(
    ...
    prompt = (
        ...
        "passages are not. The topic\u2019s own history is ON TOPIC: named "
        "people, places, and events that belong to the topic\u2019s origin "
        "story or the science behind it are CLEAN. Flag CONTAMINATED only "
        "when the excerpt describes a genuinely different story, such as a "
        "crime, assassination, war, or political event unrelated to the "
        "topic.\n\n"
