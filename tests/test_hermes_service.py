...
def config() -> HermesConfig:
    return HermesConfig(
        ...
        delegation_model="avf-tiel-coder-executor", delegation_api_mode="chat_completions",
...
def snapshot(**changes: object) -> HermesSnapshot:
    values: dict[str, object] = {
        ...
        "parent_base_url": "https://nous.example/v1", "delegation_model": "avf-tiel-coder-executor",
